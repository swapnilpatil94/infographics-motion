...
LIGHTS = {   # family -> (ambient, bloom, time, mood, description, good_for, light builder)
    ...
    "study_room": ((0.34, 0.34, 0.40), 0.35, "day", "quiet, domestic, lamp-lit", "Room with a chair, a table with a phone and a lamp, window, doorway (interaction tests)", "two-character interaction, handing over objects, table scenes"),
